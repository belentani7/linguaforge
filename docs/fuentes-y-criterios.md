...
## Fuentes verificadas para `pasted_content_3.txt` — 2026-08-20

| source                                  | url                                                                                                                      | licence                                                                    | language    | content_type                | attribution_required                       | commercial_use                             | redistribution                                                 | notes                                                                         |
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------- | ----------- | --------------------------- | ------------------------------------------ | ------------------------------------------ | -------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Council of Europe CEFR Companion Volume | https://www.coe.int/en/web/common-european-framework-reference-languages/cefr-companion-volume-and-its-language-versions | Referencia institucional; verificar términos antes de reproducir extractos | Multilingüe | Marco y descriptores        | Citar fuente                               | Uso de referencia salvo permiso específico | Usar como referencia curricular; no asumir licencia de dataset | A1–C2 son los niveles CEFR; A0 se tratará como etapa interna pre-A1           |
| Tatoeba Downloads                       | https://tatoeba.org/en/downloads                                                                                         | Textos CC BY y subconjunto CC0; audio con licencias por contribuyente      | Multilingüe | Frases y traducciones       | Sí para CC BY; conservar metadatos         | Depende de cada ítem                       | Solo bajo la licencia correspondiente                          | El pipeline actual valida JSONL y excluye audio no verificado                 |
| Tatoeba Terms of Use                    | https://tatoeba.org/en/terms_of_use                                                                                      | Condiciones de uso y licencias por frase/audio                             | Multilingüe | Procedencia y reglas de uso | Según el ítem                              | Según el ítem                              | Según el ítem                                                  | La corrección no implica revisión profesional; se requiere revisión editorial |
| Wiktionary Copyrights                   | https://en.wiktionary.org/wiki/Wiktionary:Copyrights                                                                     | CC BY-SA/GFDL para entradas originales; revisar el dataset derivado        | Multilingüe | Diccionario y metadatos     | Sí; puede existir obligación share-alike   | Sujeto a la licencia                       | Con atribución y share-alike cuando corresponda                | Fuente candidata para diccionario, no currículo automático                    |
| Kaikki.org / Wiktextract                | https://kaikki.org/ y https://github.com/tatuylonen/wiktextract                                                          | Depende de la fuente y del snapshot; auditar campos y versión              | Multilingüe | Extracción estructurada     | Conservar fuente, versión y transformación | Depende de la fuente                       | Depende de la fuente                                           | Candidato para capa léxica, no sustituto de validación pedagógica             |

El catálogo de diez idiomas permanece como configuración extensible. No se presentará como ranking mundial definitivo sin una fuente demográfica fechada y un criterio explícito que distinga hablantes nativos de hablantes totales.
