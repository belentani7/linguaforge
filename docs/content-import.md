...
El export oficial `sentences_CC0.tar.bz2` está publicado en `https://downloads.tatoeba.org/exports/sentences_CC0.tar.bz2`. Se descargó temporalmente el 20 de agosto de 2026; su SHA-256 observado fue `5484df4e000b595f780f1201dc3d1e5e14793c94a368cd7cbe9eb51b4dbd73f7`, contiene `sentences_CC0.csv` y el análisis streaming encontró 561940 filas. La distribución es desigual: `eng` 41500, `rus` 22989, `fra` 14200, `ben` 7151, `spa` 37, `por` 17, `hin` 57, `ara` 2, `jpn` 2 y `cmn` 1; por tanto, este archivo por sí solo no puede sostener 1000 entradas para 90 pares.

Su disponibilidad no elimina por sí sola el gate: para obtener pares traducidos se necesitan también relaciones completas de `links`, validación de idioma/dirección, deduplicación, asignación pedagógica y atribución. No se importará un archivo parcial ni se afirmará cobertura de producción hasta completar ese proceso.
