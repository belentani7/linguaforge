      ...
      <div className="workspace">
        ...
        <main className="main-content">
          <div className="content-wrap">
            {active === "dashboard" && <>
              <div className="page-heading"><div><p className="eyebrow">MI ESPACIO DE APRENDIZAJE</p><h1>Buenos días{user?.name ? `, ${user.name.split(" ")[0]}` : ""}. <em>Sigamos.</em></h1><p className="subheading">Tu próxima conversación empieza con una pequeña práctica.</p></div><Button onClick={() => goTo("practice")} onKeyDown={(event) => { if (event.key === "Enter") { event.preventDefault(); goTo("practice"); } }} className="button-coral"><Play size={16} fill="currentColor" />Continuar aprendiendo</Button></div>
