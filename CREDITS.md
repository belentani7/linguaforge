...
El 15 de agosto de 2026 se importó y validó un lote piloto de cinco entradas Tatoeba en español→inglés, cinco registros derivados en inglés→español y cinco entradas independientes en portugués→inglés. Las tres rutas están en versión de contenido `0.2.0`, con licencia `CC BY 2.0 FR`, URLs individuales, autoría y atribución conservadas. La transformación inversa solo intercambia los campos direccionales del mismo registro licenciado; no añade contenido propietario. El lote portugués se seleccionó mediante la API oficial con frases no desaprobadas y traducciones inglesas directas no desaprobadas; sus IDs son `13977761`, `13977758`, `13977756`, `13977746` y `13977744`. Cada par queda deliberadamente por debajo del umbral productivo de 1000 entradas y se muestra como cobertura piloto.

La arquitectura y el formato de importación están preparados, pero todavía no se ha cargado un lote masivo. Los lotes piloto deben pasar validación lingüística y revisión de duplicados antes de ampliarse. El audio queda separado hasta confirmar licencia y coste de almacenamiento.
